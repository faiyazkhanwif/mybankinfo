...
<body class="d-flex flex-column h-100 ">
    <main class="flex-shrink-0">
        ...
        <section class="py-2 animate__animated animate__fadeIn">
            <div class="container ">
                <h2 class="text-primary text-center ">Terms and Conditions</h2>
                <br>
                <p class="text-success text-center small">Last updated: September 04, 2021</p>
                <p class="text-danger text-center small">Please read these terms and conditions carefully before using Our Service.</p>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to HireDev, 123 street, Dhaka.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to HireDev, accessible from <a href="hiredev.io" rel="external nofollow noopener" target="_blank">hiredev.io</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: contact@hiredev.com</li>
                </ul>
