<div class="row">
    ...
    <div class="my-form col-lg-8">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bolder"><b>Add ATM Location and Details</b></h2>
        </div>
        <div id="form-header"></div>

        <?= form_open('Admin/addatm') ?>
        ...
        <div class="form-group">
            ...
            <?= form_textarea(['name' => 'address', 'placeholder' => 'Address of the ATM', 'value' => set_value('address'), 'class' => 'form-control']) ?>
