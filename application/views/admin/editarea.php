<div class="row">
    ...
    <div class="col-lg-8">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bolder"><b>Edit Area</b></h2>
        </div>
        <?= form_open('Admin/edit_area/' . $this->uri->segment(3)) ?>
        <div id="form-header"></div>

        <div class="form-group">
            <label for="name" class="fw-bolder"><b>Name</b></label>
            <?= form_input(['name' => 'area', 'placeholder' => 'Area Name', 'value' => set_value('name', $area_details->areaname), 'class' => 'form-control']) ?>
