<div class="row">
    ...
    <div class="col-lg-8">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bolder"><b>Edit Branch Details</b></h2>
        </div>
        <div>
            <p><sup><b>** Parent Bank and Area of a branch cannot be changed once the branch is already created.</b></sup></p>
        </div>
        <?= form_open('Admin/edit_branch/' . $this->uri->segment(3)) ?>
        <div id="form-header"></div>

        <div class="form-group">
            <label for="bank" class="fw-bolder"><b>Bank </b> <i>(Not Editable)</i></label>
            <input class="form-control" type="text" value='<?= set_value('bank', $branch_details->bankname) ?>' disabled>
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" value='<?= set_value('area', $branch_details->areaname) ?>' disabled>
        ...
        <div class="form-group">
            ...
            <?= form_textarea(['name' => 'address', 'placeholder' => 'Address of the branch', 'value' => set_value('address', $branch_details->address), 'class' => 'form-control']) ?>
        ...
        <div class="form-group">
            ...
            <?= form_textarea(['name' => 'map', 'placeholder' => 'Map iframe', 'value' => $branch_details->map, 'class' => 'form-control']) ?>
            <div class="text-danger form-error"><?= form_error('map') ?></div>
        </div>
        <br>
        <div class="form-group">
            <label for="contact" class="fw-bolder"><b>Contact</b></label>
            <?= form_input(['name' => 'contact', 'placeholder' => 'Contact number', 'value' => set_value('contact', $branch_details->contact), 'class' => 'form-control']) ?>
        ...
        <div class="form-group">
            ...
            <?= form_textarea(['name' => 'addinfo', 'placeholder' => 'E.g. Working hours', 'value' => set_value('addinfo', $branch_details->addinfo), 'class' => 'form-control']) ?>
